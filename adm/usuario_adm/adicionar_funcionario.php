        ...
        <form action="salvar_funcionario.php" method="post" class="m-3 container">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="matricula" placeholder="Digite 5 digitos"
                        name="matricula" pattern="\d{5}" title="Digite exatamente 5 números" required>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="salario" name="salario"
                        pattern="^\d{1,3}(\.\d{3})*(,\d{2})?$" title="Digite um valor válido  Ex: 5.000,00" required>
                </div>
