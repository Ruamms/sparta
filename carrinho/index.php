    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($row['estoque'] > 0) {
                ...
                echo '<script>showAlert("Produto adicionado ao carrinho!", "success");</script>';
            } else {
    ...
    <div class="container  ">
        <div class="row mt-3 mx-auto container">
            <div class="col-md-12">
                ...
                <h2 class="mt-3 text-center">Adicione Produtos ao carrinho</h2>

                <div class="row align-middle  m-4">
