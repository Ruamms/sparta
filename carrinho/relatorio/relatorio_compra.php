        ...
        if ($result_compras->num_rows > 0) {
          ...
          <div class="container mt-5 ">
            ...
            while ($row_compra = $result_compras->fetch_assoc()) {
              ...
              <div class="m-5 card">
                <div class="mt-3  m-2">
                  <h5>Pedido realizado: <?php echo $data_pedido; ?></h5>
                  <div class="m-3">
                    <p>Número do pedido: <?php echo $pedido_id; ?></p>
                    <p>Valor Total: R$ <?php echo $valor_total; ?></p>
                    
                    <h5 class="text-center">Produtos adquiridos</h5>
                    <ul class="list-group">
                      <?php while ($row_detalhes = $result_detalhes_pedido->fetch_assoc()) { ?>
                        <li class="list-group-item">
                          <?php echo $row_detalhes['nome']; ?> -
                          Quantidade: <?php echo $row_detalhes['quantidade']; ?>
                        </li>
                      <?php } ?>
                    </ul>
                  </div>
